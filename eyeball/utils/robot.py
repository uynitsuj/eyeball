...
if __name__ == '__main__':
    robot = Robot("ttyUSB0")
    m1 = robot.add_motor(0x01, 0.1, "Azimuth", True, [0.0, 0.0, 0.0], "YZ")
    m2 = robot.add_motor(0x02, 0.1, "Elevation", True, [0.0, 0.0, 0.0], "YZ")
    
    robot.goto_abs_multi_loop_angles_speeds([90, 90], [300, 300])
